    ...
    try {
      const response = await axios.put(
        `http://localhost:3000/update/${id}`,
        {
          ...
          document:document||formData.document,
          status: formData.status, // Add the status field to match your sample data
        },
        {
          headers: {
      ...
      Swal.fire('Added!', 'Edit is complete successfully.', 'success');
      navigate(`/admission`);
    } catch (error) {
  ...
  return (
    <div style={styles.container}>
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
        ...
        {/* Religion */}
        <label htmlFor="religion" style={styles.label}>
          Religion:
        </label>
        <input
          type="text"
